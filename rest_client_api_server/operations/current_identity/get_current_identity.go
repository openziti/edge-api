...
type GetCurrentIdentityHandlerFunc func(GetCurrentIdentityParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn GetCurrentIdentityHandlerFunc) Handle(params GetCurrentIdentityParams, principal any) middleware.Responder {
...
type GetCurrentIdentityHandler interface {
	Handle(GetCurrentIdentityParams, any) middleware.Responder
}
