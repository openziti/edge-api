...
type DeleteSessionHandlerFunc func(DeleteSessionParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteSessionHandlerFunc) Handle(params DeleteSessionParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// DeleteSessionHandler interface for that can handle valid delete session params
type DeleteSessionHandler interface {
	Handle(DeleteSessionParams, any) middleware.Responder
}
