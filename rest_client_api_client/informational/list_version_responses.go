...
// bindHeaderListVersionOK binds the response header WWW-Authenticate
func (o *ListVersionOK) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
