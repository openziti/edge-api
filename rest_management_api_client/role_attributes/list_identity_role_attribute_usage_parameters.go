...
// NewListIdentityRoleAttributeUsageParams creates a new ListIdentityRoleAttributeUsageParams object,
...
func NewListIdentityRoleAttributeUsageParams() *ListIdentityRoleAttributeUsageParams {
	return &ListIdentityRoleAttributeUsageParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListIdentityRoleAttributeUsageParamsWithTimeout creates a new ListIdentityRoleAttributeUsageParams object
...
// NewListIdentityRoleAttributeUsageParamsWithContext creates a new ListIdentityRoleAttributeUsageParams object
...
// NewListIdentityRoleAttributeUsageParamsWithHTTPClient creates a new ListIdentityRoleAttributeUsageParams object
...
func (o *ListIdentityRoleAttributeUsageParams) WithDefaults() *ListIdentityRoleAttributeUsageParams {
	o.SetDefaults()
	return o
}
...
func (o *ListIdentityRoleAttributeUsageParams) WithTimeout(timeout time.Duration) *ListIdentityRoleAttributeUsageParams {
...
func (o *ListIdentityRoleAttributeUsageParams) WithContext(ctx context.Context) *ListIdentityRoleAttributeUsageParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list identity role attribute usage params
func (o *ListIdentityRoleAttributeUsageParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list identity role attribute usage params
func (o *ListIdentityRoleAttributeUsageParams) WithHTTPClient(client *http.Client) *ListIdentityRoleAttributeUsageParams {
...
func (o *ListIdentityRoleAttributeUsageParams) WithFilter(filter *string) *ListIdentityRoleAttributeUsageParams {
	o.SetFilter(filter)
	return o
}
...
func (o *ListIdentityRoleAttributeUsageParams) WithLimit(limit *int64) *ListIdentityRoleAttributeUsageParams {
	o.SetLimit(limit)
	return o
}
...
func (o *ListIdentityRoleAttributeUsageParams) WithOffset(offset *int64) *ListIdentityRoleAttributeUsageParams {
	o.SetOffset(offset)
	return o
}
...
func (o *ListIdentityRoleAttributeUsageParams) WithWithIds(withIds *bool) *ListIdentityRoleAttributeUsageParams {
...
func (o *ListIdentityRoleAttributeUsageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
