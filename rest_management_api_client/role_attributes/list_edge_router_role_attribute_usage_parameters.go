...
// NewListEdgeRouterRoleAttributeUsageParams creates a new ListEdgeRouterRoleAttributeUsageParams object,
...
func NewListEdgeRouterRoleAttributeUsageParams() *ListEdgeRouterRoleAttributeUsageParams {
	return &ListEdgeRouterRoleAttributeUsageParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListEdgeRouterRoleAttributeUsageParamsWithTimeout creates a new ListEdgeRouterRoleAttributeUsageParams object
...
// NewListEdgeRouterRoleAttributeUsageParamsWithContext creates a new ListEdgeRouterRoleAttributeUsageParams object
...
// NewListEdgeRouterRoleAttributeUsageParamsWithHTTPClient creates a new ListEdgeRouterRoleAttributeUsageParams object
...
func (o *ListEdgeRouterRoleAttributeUsageParams) WithDefaults() *ListEdgeRouterRoleAttributeUsageParams {
	o.SetDefaults()
	return o
}
...
func (o *ListEdgeRouterRoleAttributeUsageParams) WithTimeout(timeout time.Duration) *ListEdgeRouterRoleAttributeUsageParams {
...
func (o *ListEdgeRouterRoleAttributeUsageParams) WithContext(ctx context.Context) *ListEdgeRouterRoleAttributeUsageParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list edge router role attribute usage params
func (o *ListEdgeRouterRoleAttributeUsageParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list edge router role attribute usage params
func (o *ListEdgeRouterRoleAttributeUsageParams) WithHTTPClient(client *http.Client) *ListEdgeRouterRoleAttributeUsageParams {
...
func (o *ListEdgeRouterRoleAttributeUsageParams) WithFilter(filter *string) *ListEdgeRouterRoleAttributeUsageParams {
	o.SetFilter(filter)
	return o
}
...
func (o *ListEdgeRouterRoleAttributeUsageParams) WithLimit(limit *int64) *ListEdgeRouterRoleAttributeUsageParams {
	o.SetLimit(limit)
	return o
}
...
func (o *ListEdgeRouterRoleAttributeUsageParams) WithOffset(offset *int64) *ListEdgeRouterRoleAttributeUsageParams {
	o.SetOffset(offset)
	return o
}
...
func (o *ListEdgeRouterRoleAttributeUsageParams) WithWithIds(withIds *bool) *ListEdgeRouterRoleAttributeUsageParams {
...
func (o *ListEdgeRouterRoleAttributeUsageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
