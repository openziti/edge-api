...
// NewListServiceRoleAttributeUsageParams creates a new ListServiceRoleAttributeUsageParams object,
...
func NewListServiceRoleAttributeUsageParams() *ListServiceRoleAttributeUsageParams {
	return &ListServiceRoleAttributeUsageParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListServiceRoleAttributeUsageParamsWithTimeout creates a new ListServiceRoleAttributeUsageParams object
...
// NewListServiceRoleAttributeUsageParamsWithContext creates a new ListServiceRoleAttributeUsageParams object
...
// NewListServiceRoleAttributeUsageParamsWithHTTPClient creates a new ListServiceRoleAttributeUsageParams object
...
func (o *ListServiceRoleAttributeUsageParams) WithDefaults() *ListServiceRoleAttributeUsageParams {
	o.SetDefaults()
	return o
}
...
func (o *ListServiceRoleAttributeUsageParams) WithTimeout(timeout time.Duration) *ListServiceRoleAttributeUsageParams {
...
func (o *ListServiceRoleAttributeUsageParams) WithContext(ctx context.Context) *ListServiceRoleAttributeUsageParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list service role attribute usage params
func (o *ListServiceRoleAttributeUsageParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list service role attribute usage params
func (o *ListServiceRoleAttributeUsageParams) WithHTTPClient(client *http.Client) *ListServiceRoleAttributeUsageParams {
...
func (o *ListServiceRoleAttributeUsageParams) WithFilter(filter *string) *ListServiceRoleAttributeUsageParams {
	o.SetFilter(filter)
	return o
}
...
func (o *ListServiceRoleAttributeUsageParams) WithLimit(limit *int64) *ListServiceRoleAttributeUsageParams {
	o.SetLimit(limit)
	return o
}
...
func (o *ListServiceRoleAttributeUsageParams) WithOffset(offset *int64) *ListServiceRoleAttributeUsageParams {
	o.SetOffset(offset)
	return o
}
...
func (o *ListServiceRoleAttributeUsageParams) WithWithIds(withIds *bool) *ListServiceRoleAttributeUsageParams {
...
func (o *ListServiceRoleAttributeUsageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
