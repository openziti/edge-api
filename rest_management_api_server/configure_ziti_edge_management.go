...
//go:generate swagger generate server --target ../../edge-api --name ZitiEdgeManagement --spec ../management.yml --model-package rest_model --server-package rest_management_api_server --principal any --exclude-main
...
func configureAPI(api *operations.ZitiEdgeManagementAPI) http.Handler {
	...
	api.ApplicationJWTProducer = runtime.ProducerFunc(func(w io.Writer, data any) error {
		_ = w
		_ = data

		return errors.NotImplemented("applicationJwt producer has not yet been implemented")
	})
	api.ApplicationPkcs7MimeProducer = runtime.ProducerFunc(func(w io.Writer, data any) error {
		_ = w
		_ = data
	...
	api.TextYamlProducer = runtime.ProducerFunc(func(w io.Writer, data any) error {
		_ = w
		_ = data
	...
	if api.CurrentAPISessionDeleteCurrentAPISessionHandler == nil {
		api.CurrentAPISessionDeleteCurrentAPISessionHandler = current_api_session.DeleteCurrentAPISessionHandlerFunc(func(params current_api_session.DeleteCurrentAPISessionParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityAssociateIdentitysServiceConfigsHandler == nil {
		api.IdentityAssociateIdentitysServiceConfigsHandler = identity.AssociateIdentitysServiceConfigsHandlerFunc(func(params identity.AssociateIdentitysServiceConfigsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticationAuthenticateMfaHandler == nil {
		api.AuthenticationAuthenticateMfaHandler = authentication.AuthenticateMfaHandlerFunc(func(params authentication.AuthenticateMfaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthPolicyCreateAuthPolicyHandler == nil {
		api.AuthPolicyCreateAuthPolicyHandler = auth_policy.CreateAuthPolicyHandlerFunc(func(params auth_policy.CreateAuthPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticatorCreateAuthenticatorHandler == nil {
		api.AuthenticatorCreateAuthenticatorHandler = authenticator.CreateAuthenticatorHandlerFunc(func(params authenticator.CreateAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CertificateAuthorityCreateCaHandler == nil {
		api.CertificateAuthorityCreateCaHandler = certificate_authority.CreateCaHandlerFunc(func(params certificate_authority.CreateCaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigCreateConfigHandler == nil {
		api.ConfigCreateConfigHandler = config.CreateConfigHandlerFunc(func(params config.CreateConfigParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigCreateConfigTypeHandler == nil {
		api.ConfigCreateConfigTypeHandler = config.CreateConfigTypeHandlerFunc(func(params config.CreateConfigTypeParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SettingsCreateControllerSettingHandler == nil {
		api.SettingsCreateControllerSettingHandler = settings.CreateControllerSettingHandlerFunc(func(params settings.CreateControllerSettingParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterCreateEdgeRouterHandler == nil {
		api.EdgeRouterCreateEdgeRouterHandler = edge_router.CreateEdgeRouterHandlerFunc(func(params edge_router.CreateEdgeRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterPolicyCreateEdgeRouterPolicyHandler == nil {
		api.EdgeRouterPolicyCreateEdgeRouterPolicyHandler = edge_router_policy.CreateEdgeRouterPolicyHandlerFunc(func(params edge_router_policy.CreateEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EnrollmentCreateEnrollmentHandler == nil {
		api.EnrollmentCreateEnrollmentHandler = enrollment.CreateEnrollmentHandlerFunc(func(params enrollment.CreateEnrollmentParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ExternalJWTSignerCreateExternalJWTSignerHandler == nil {
		api.ExternalJWTSignerCreateExternalJWTSignerHandler = external_jwt_signer.CreateExternalJWTSignerHandlerFunc(func(params external_jwt_signer.CreateExternalJWTSignerParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityCreateIdentityHandler == nil {
		api.IdentityCreateIdentityHandler = identity.CreateIdentityHandlerFunc(func(params identity.CreateIdentityParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentIdentityCreateMfaRecoveryCodesHandler == nil {
		api.CurrentIdentityCreateMfaRecoveryCodesHandler = current_identity.CreateMfaRecoveryCodesHandlerFunc(func(params current_identity.CreateMfaRecoveryCodesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.PostureChecksCreatePostureCheckHandler == nil {
		api.PostureChecksCreatePostureCheckHandler = posture_checks.CreatePostureCheckHandlerFunc(func(params posture_checks.CreatePostureCheckParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceEdgeRouterPolicyCreateServiceEdgeRouterPolicyHandler == nil {
		api.ServiceEdgeRouterPolicyCreateServiceEdgeRouterPolicyHandler = service_edge_router_policy.CreateServiceEdgeRouterPolicyHandlerFunc(func(params service_edge_router_policy.CreateServiceEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServicePolicyCreateServicePolicyHandler == nil {
		api.ServicePolicyCreateServicePolicyHandler = service_policy.CreateServicePolicyHandlerFunc(func(params service_policy.CreateServicePolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentAPISessionCreateTotpTokenHandler == nil {
		api.CurrentAPISessionCreateTotpTokenHandler = current_api_session.CreateTotpTokenHandlerFunc(func(params current_api_session.CreateTotpTokenParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.RouterCreateTransitRouterHandler == nil {
		api.RouterCreateTransitRouterHandler = router.CreateTransitRouterHandlerFunc(func(params router.CreateTransitRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.APISessionDeleteAPISessionsHandler == nil {
		api.APISessionDeleteAPISessionsHandler = api_session.DeleteAPISessionsHandlerFunc(func(params api_session.DeleteAPISessionsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthPolicyDeleteAuthPolicyHandler == nil {
		api.AuthPolicyDeleteAuthPolicyHandler = auth_policy.DeleteAuthPolicyHandlerFunc(func(params auth_policy.DeleteAuthPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticatorDeleteAuthenticatorHandler == nil {
		api.AuthenticatorDeleteAuthenticatorHandler = authenticator.DeleteAuthenticatorHandlerFunc(func(params authenticator.DeleteAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CertificateAuthorityDeleteCaHandler == nil {
		api.CertificateAuthorityDeleteCaHandler = certificate_authority.DeleteCaHandlerFunc(func(params certificate_authority.DeleteCaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigDeleteConfigHandler == nil {
		api.ConfigDeleteConfigHandler = config.DeleteConfigHandlerFunc(func(params config.DeleteConfigParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigDeleteConfigTypeHandler == nil {
		api.ConfigDeleteConfigTypeHandler = config.DeleteConfigTypeHandlerFunc(func(params config.DeleteConfigTypeParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SettingsDeleteControllerSettingHandler == nil {
		api.SettingsDeleteControllerSettingHandler = settings.DeleteControllerSettingHandlerFunc(func(params settings.DeleteControllerSettingParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterDeleteEdgeRouterHandler == nil {
		api.EdgeRouterDeleteEdgeRouterHandler = edge_router.DeleteEdgeRouterHandlerFunc(func(params edge_router.DeleteEdgeRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterPolicyDeleteEdgeRouterPolicyHandler == nil {
		api.EdgeRouterPolicyDeleteEdgeRouterPolicyHandler = edge_router_policy.DeleteEdgeRouterPolicyHandlerFunc(func(params edge_router_policy.DeleteEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EnrollmentDeleteEnrollmentHandler == nil {
		api.EnrollmentDeleteEnrollmentHandler = enrollment.DeleteEnrollmentHandlerFunc(func(params enrollment.DeleteEnrollmentParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ExternalJWTSignerDeleteExternalJWTSignerHandler == nil {
		api.ExternalJWTSignerDeleteExternalJWTSignerHandler = external_jwt_signer.DeleteExternalJWTSignerHandlerFunc(func(params external_jwt_signer.DeleteExternalJWTSignerParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityDeleteIdentityHandler == nil {
		api.IdentityDeleteIdentityHandler = identity.DeleteIdentityHandlerFunc(func(params identity.DeleteIdentityParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentIdentityDeleteMfaHandler == nil {
		api.CurrentIdentityDeleteMfaHandler = current_identity.DeleteMfaHandlerFunc(func(params current_identity.DeleteMfaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.PostureChecksDeletePostureCheckHandler == nil {
		api.PostureChecksDeletePostureCheckHandler = posture_checks.DeletePostureCheckHandlerFunc(func(params posture_checks.DeletePostureCheckParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceEdgeRouterPolicyDeleteServiceEdgeRouterPolicyHandler == nil {
		api.ServiceEdgeRouterPolicyDeleteServiceEdgeRouterPolicyHandler = service_edge_router_policy.DeleteServiceEdgeRouterPolicyHandlerFunc(func(params service_edge_router_policy.DeleteServiceEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServicePolicyDeleteServicePolicyHandler == nil {
		api.ServicePolicyDeleteServicePolicyHandler = service_policy.DeleteServicePolicyHandlerFunc(func(params service_policy.DeleteServicePolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SessionDeleteSessionHandler == nil {
		api.SessionDeleteSessionHandler = session.DeleteSessionHandlerFunc(func(params session.DeleteSessionParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.RouterDeleteTransitRouterHandler == nil {
		api.RouterDeleteTransitRouterHandler = router.DeleteTransitRouterHandlerFunc(func(params router.DeleteTransitRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.APISessionDetailAPISessionsHandler == nil {
		api.APISessionDetailAPISessionsHandler = api_session.DetailAPISessionsHandlerFunc(func(params api_session.DetailAPISessionsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthPolicyDetailAuthPolicyHandler == nil {
		api.AuthPolicyDetailAuthPolicyHandler = auth_policy.DetailAuthPolicyHandlerFunc(func(params auth_policy.DetailAuthPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticatorDetailAuthenticatorHandler == nil {
		api.AuthenticatorDetailAuthenticatorHandler = authenticator.DetailAuthenticatorHandlerFunc(func(params authenticator.DetailAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CertificateAuthorityDetailCaHandler == nil {
		api.CertificateAuthorityDetailCaHandler = certificate_authority.DetailCaHandlerFunc(func(params certificate_authority.DetailCaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigDetailConfigHandler == nil {
		api.ConfigDetailConfigHandler = config.DetailConfigHandlerFunc(func(params config.DetailConfigParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigDetailConfigTypeHandler == nil {
		api.ConfigDetailConfigTypeHandler = config.DetailConfigTypeHandlerFunc(func(params config.DetailConfigTypeParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SettingsDetailControllerSettingHandler == nil {
		api.SettingsDetailControllerSettingHandler = settings.DetailControllerSettingHandlerFunc(func(params settings.DetailControllerSettingParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SettingsDetailControllerSettingEffectiveHandler == nil {
		api.SettingsDetailControllerSettingEffectiveHandler = settings.DetailControllerSettingEffectiveHandlerFunc(func(params settings.DetailControllerSettingEffectiveParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentAPISessionDetailCurrentIdentityAuthenticatorHandler == nil {
		api.CurrentAPISessionDetailCurrentIdentityAuthenticatorHandler = current_api_session.DetailCurrentIdentityAuthenticatorHandlerFunc(func(params current_api_session.DetailCurrentIdentityAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterDetailEdgeRouterHandler == nil {
		api.EdgeRouterDetailEdgeRouterHandler = edge_router.DetailEdgeRouterHandlerFunc(func(params edge_router.DetailEdgeRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterPolicyDetailEdgeRouterPolicyHandler == nil {
		api.EdgeRouterPolicyDetailEdgeRouterPolicyHandler = edge_router_policy.DetailEdgeRouterPolicyHandlerFunc(func(params edge_router_policy.DetailEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EnrollmentDetailEnrollmentHandler == nil {
		api.EnrollmentDetailEnrollmentHandler = enrollment.DetailEnrollmentHandlerFunc(func(params enrollment.DetailEnrollmentParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ExternalJWTSignerDetailExternalJWTSignerHandler == nil {
		api.ExternalJWTSignerDetailExternalJWTSignerHandler = external_jwt_signer.DetailExternalJWTSignerHandlerFunc(func(params external_jwt_signer.DetailExternalJWTSignerParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityDetailIdentityHandler == nil {
		api.IdentityDetailIdentityHandler = identity.DetailIdentityHandlerFunc(func(params identity.DetailIdentityParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityDetailIdentityTypeHandler == nil {
		api.IdentityDetailIdentityTypeHandler = identity.DetailIdentityTypeHandlerFunc(func(params identity.DetailIdentityTypeParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentIdentityDetailMfaHandler == nil {
		api.CurrentIdentityDetailMfaHandler = current_identity.DetailMfaHandlerFunc(func(params current_identity.DetailMfaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentIdentityDetailMfaQrCodeHandler == nil {
		api.CurrentIdentityDetailMfaQrCodeHandler = current_identity.DetailMfaQrCodeHandlerFunc(func(params current_identity.DetailMfaQrCodeParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentIdentityDetailMfaRecoveryCodesHandler == nil {
		api.CurrentIdentityDetailMfaRecoveryCodesHandler = current_identity.DetailMfaRecoveryCodesHandlerFunc(func(params current_identity.DetailMfaRecoveryCodesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.PostureChecksDetailPostureCheckHandler == nil {
		api.PostureChecksDetailPostureCheckHandler = posture_checks.DetailPostureCheckHandlerFunc(func(params posture_checks.DetailPostureCheckParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.PostureChecksDetailPostureCheckTypeHandler == nil {
		api.PostureChecksDetailPostureCheckTypeHandler = posture_checks.DetailPostureCheckTypeHandlerFunc(func(params posture_checks.DetailPostureCheckTypeParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceEdgeRouterPolicyDetailServiceEdgeRouterPolicyHandler == nil {
		api.ServiceEdgeRouterPolicyDetailServiceEdgeRouterPolicyHandler = service_edge_router_policy.DetailServiceEdgeRouterPolicyHandlerFunc(func(params service_edge_router_policy.DetailServiceEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServicePolicyDetailServicePolicyHandler == nil {
		api.ServicePolicyDetailServicePolicyHandler = service_policy.DetailServicePolicyHandlerFunc(func(params service_policy.DetailServicePolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SessionDetailSessionHandler == nil {
		api.SessionDetailSessionHandler = session.DetailSessionHandlerFunc(func(params session.DetailSessionParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SessionDetailSessionRoutePathHandler == nil {
		api.SessionDetailSessionRoutePathHandler = session.DetailSessionRoutePathHandlerFunc(func(params session.DetailSessionRoutePathParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.RouterDetailTransitRouterHandler == nil {
		api.RouterDetailTransitRouterHandler = router.DetailTransitRouterHandlerFunc(func(params router.DetailTransitRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityDisableIdentityHandler == nil {
		api.IdentityDisableIdentityHandler = identity.DisableIdentityHandlerFunc(func(params identity.DisableIdentityParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityDisassociateIdentitysServiceConfigsHandler == nil {
		api.IdentityDisassociateIdentitysServiceConfigsHandler = identity.DisassociateIdentitysServiceConfigsHandlerFunc(func(params identity.DisassociateIdentitysServiceConfigsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityEnableIdentityHandler == nil {
		api.IdentityEnableIdentityHandler = identity.EnableIdentityHandlerFunc(func(params identity.EnableIdentityParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentIdentityEnrollMfaHandler == nil {
		api.CurrentIdentityEnrollMfaHandler = current_identity.EnrollMfaHandlerFunc(func(params current_identity.EnrollMfaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentAPISessionExtendCurrentIdentityAuthenticatorHandler == nil {
		api.CurrentAPISessionExtendCurrentIdentityAuthenticatorHandler = current_api_session.ExtendCurrentIdentityAuthenticatorHandlerFunc(func(params current_api_session.ExtendCurrentIdentityAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentAPISessionExtendVerifyCurrentIdentityAuthenticatorHandler == nil {
		api.CurrentAPISessionExtendVerifyCurrentIdentityAuthenticatorHandler = current_api_session.ExtendVerifyCurrentIdentityAuthenticatorHandlerFunc(func(params current_api_session.ExtendVerifyCurrentIdentityAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CertificateAuthorityGetCaJWTHandler == nil {
		api.CertificateAuthorityGetCaJWTHandler = certificate_authority.GetCaJWTHandlerFunc(func(params certificate_authority.GetCaJWTParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentAPISessionGetCurrentAPISessionHandler == nil {
		api.CurrentAPISessionGetCurrentAPISessionHandler = current_api_session.GetCurrentAPISessionHandlerFunc(func(params current_api_session.GetCurrentAPISessionParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentIdentityGetCurrentIdentityHandler == nil {
		api.CurrentIdentityGetCurrentIdentityHandler = current_identity.GetCurrentIdentityHandlerFunc(func(params current_identity.GetCurrentIdentityParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityGetIdentityAuthenticatorsHandler == nil {
		api.IdentityGetIdentityAuthenticatorsHandler = identity.GetIdentityAuthenticatorsHandlerFunc(func(params identity.GetIdentityAuthenticatorsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityGetIdentityEnrollmentsHandler == nil {
		api.IdentityGetIdentityEnrollmentsHandler = identity.GetIdentityEnrollmentsHandlerFunc(func(params identity.GetIdentityEnrollmentsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityGetIdentityFailedServiceRequestsHandler == nil {
		api.IdentityGetIdentityFailedServiceRequestsHandler = identity.GetIdentityFailedServiceRequestsHandlerFunc(func(params identity.GetIdentityFailedServiceRequestsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityGetIdentityPolicyAdviceHandler == nil {
		api.IdentityGetIdentityPolicyAdviceHandler = identity.GetIdentityPolicyAdviceHandlerFunc(func(params identity.GetIdentityPolicyAdviceParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityGetIdentityPostureDataHandler == nil {
		api.IdentityGetIdentityPostureDataHandler = identity.GetIdentityPostureDataHandlerFunc(func(params identity.GetIdentityPostureDataParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.APISessionListAPISessionsHandler == nil {
		api.APISessionListAPISessionsHandler = api_session.ListAPISessionsHandlerFunc(func(params api_session.ListAPISessionsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthPolicyListAuthPoliciesHandler == nil {
		api.AuthPolicyListAuthPoliciesHandler = auth_policy.ListAuthPoliciesHandlerFunc(func(params auth_policy.ListAuthPoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticatorListAuthenticatorsHandler == nil {
		api.AuthenticatorListAuthenticatorsHandler = authenticator.ListAuthenticatorsHandlerFunc(func(params authenticator.ListAuthenticatorsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CertificateAuthorityListCasHandler == nil {
		api.CertificateAuthorityListCasHandler = certificate_authority.ListCasHandlerFunc(func(params certificate_authority.ListCasParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigListConfigServicesHandler == nil {
		api.ConfigListConfigServicesHandler = config.ListConfigServicesHandlerFunc(func(params config.ListConfigServicesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigListConfigTypesHandler == nil {
		api.ConfigListConfigTypesHandler = config.ListConfigTypesHandlerFunc(func(params config.ListConfigTypesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigListConfigsHandler == nil {
		api.ConfigListConfigsHandler = config.ListConfigsHandlerFunc(func(params config.ListConfigsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigListConfigsForConfigTypeHandler == nil {
		api.ConfigListConfigsForConfigTypeHandler = config.ListConfigsForConfigTypeHandlerFunc(func(params config.ListConfigsForConfigTypeParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SettingsListControllerSettingsHandler == nil {
		api.SettingsListControllerSettingsHandler = settings.ListControllerSettingsHandlerFunc(func(params settings.ListControllerSettingsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ControllersListControllersHandler == nil {
		api.ControllersListControllersHandler = controllers.ListControllersHandlerFunc(func(params controllers.ListControllersParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentAPISessionListCurrentIdentityAuthenticatorsHandler == nil {
		api.CurrentAPISessionListCurrentIdentityAuthenticatorsHandler = current_api_session.ListCurrentIdentityAuthenticatorsHandlerFunc(func(params current_api_session.ListCurrentIdentityAuthenticatorsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterListEdgeRouterEdgeRouterPoliciesHandler == nil {
		api.EdgeRouterListEdgeRouterEdgeRouterPoliciesHandler = edge_router.ListEdgeRouterEdgeRouterPoliciesHandlerFunc(func(params edge_router.ListEdgeRouterEdgeRouterPoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterListEdgeRouterIdentitiesHandler == nil {
		api.EdgeRouterListEdgeRouterIdentitiesHandler = edge_router.ListEdgeRouterIdentitiesHandlerFunc(func(params edge_router.ListEdgeRouterIdentitiesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterPolicyListEdgeRouterPoliciesHandler == nil {
		api.EdgeRouterPolicyListEdgeRouterPoliciesHandler = edge_router_policy.ListEdgeRouterPoliciesHandlerFunc(func(params edge_router_policy.ListEdgeRouterPoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterPolicyListEdgeRouterPolicyEdgeRoutersHandler == nil {
		api.EdgeRouterPolicyListEdgeRouterPolicyEdgeRoutersHandler = edge_router_policy.ListEdgeRouterPolicyEdgeRoutersHandlerFunc(func(params edge_router_policy.ListEdgeRouterPolicyEdgeRoutersParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterPolicyListEdgeRouterPolicyIdentitiesHandler == nil {
		api.EdgeRouterPolicyListEdgeRouterPolicyIdentitiesHandler = edge_router_policy.ListEdgeRouterPolicyIdentitiesHandlerFunc(func(params edge_router_policy.ListEdgeRouterPolicyIdentitiesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterListEdgeRouterServiceEdgeRouterPoliciesHandler == nil {
		api.EdgeRouterListEdgeRouterServiceEdgeRouterPoliciesHandler = edge_router.ListEdgeRouterServiceEdgeRouterPoliciesHandlerFunc(func(params edge_router.ListEdgeRouterServiceEdgeRouterPoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterListEdgeRouterServicesHandler == nil {
		api.EdgeRouterListEdgeRouterServicesHandler = edge_router.ListEdgeRouterServicesHandlerFunc(func(params edge_router.ListEdgeRouterServicesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterListEdgeRoutersHandler == nil {
		api.EdgeRouterListEdgeRoutersHandler = edge_router.ListEdgeRoutersHandlerFunc(func(params edge_router.ListEdgeRoutersParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EnrollmentListEnrollmentsHandler == nil {
		api.EnrollmentListEnrollmentsHandler = enrollment.ListEnrollmentsHandlerFunc(func(params enrollment.ListEnrollmentsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ExternalJWTSignerListExternalJWTSignersHandler == nil {
		api.ExternalJWTSignerListExternalJWTSignersHandler = external_jwt_signer.ListExternalJWTSignersHandlerFunc(func(params external_jwt_signer.ListExternalJWTSignersParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityListIdentitiesHandler == nil {
		api.IdentityListIdentitiesHandler = identity.ListIdentitiesHandlerFunc(func(params identity.ListIdentitiesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityListIdentityEdgeRoutersHandler == nil {
		api.IdentityListIdentityEdgeRoutersHandler = identity.ListIdentityEdgeRoutersHandlerFunc(func(params identity.ListIdentityEdgeRoutersParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityListIdentityServicePoliciesHandler == nil {
		api.IdentityListIdentityServicePoliciesHandler = identity.ListIdentityServicePoliciesHandlerFunc(func(params identity.ListIdentityServicePoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityListIdentityServicesHandler == nil {
		api.IdentityListIdentityServicesHandler = identity.ListIdentityServicesHandlerFunc(func(params identity.ListIdentityServicesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityListIdentityTypesHandler == nil {
		api.IdentityListIdentityTypesHandler = identity.ListIdentityTypesHandlerFunc(func(params identity.ListIdentityTypesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityListIdentitysEdgeRouterPoliciesHandler == nil {
		api.IdentityListIdentitysEdgeRouterPoliciesHandler = identity.ListIdentitysEdgeRouterPoliciesHandlerFunc(func(params identity.ListIdentitysEdgeRouterPoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityListIdentitysServiceConfigsHandler == nil {
		api.IdentityListIdentitysServiceConfigsHandler = identity.ListIdentitysServiceConfigsHandlerFunc(func(params identity.ListIdentitysServiceConfigsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.RoleAttributesListPostureCheckRoleAttributesHandler == nil {
		api.RoleAttributesListPostureCheckRoleAttributesHandler = role_attributes.ListPostureCheckRoleAttributesHandlerFunc(func(params role_attributes.ListPostureCheckRoleAttributesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.PostureChecksListPostureCheckTypesHandler == nil {
		api.PostureChecksListPostureCheckTypesHandler = posture_checks.ListPostureCheckTypesHandlerFunc(func(params posture_checks.ListPostureCheckTypesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.PostureChecksListPostureChecksHandler == nil {
		api.PostureChecksListPostureChecksHandler = posture_checks.ListPostureChecksHandlerFunc(func(params posture_checks.ListPostureChecksParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceListServiceConfigHandler == nil {
		api.ServiceListServiceConfigHandler = service.ListServiceConfigHandlerFunc(func(params service.ListServiceConfigParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceEdgeRouterPolicyListServiceEdgeRouterPoliciesHandler == nil {
		api.ServiceEdgeRouterPolicyListServiceEdgeRouterPoliciesHandler = service_edge_router_policy.ListServiceEdgeRouterPoliciesHandlerFunc(func(params service_edge_router_policy.ListServiceEdgeRouterPoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceEdgeRouterPolicyListServiceEdgeRouterPolicyEdgeRoutersHandler == nil {
		api.ServiceEdgeRouterPolicyListServiceEdgeRouterPolicyEdgeRoutersHandler = service_edge_router_policy.ListServiceEdgeRouterPolicyEdgeRoutersHandlerFunc(func(params service_edge_router_policy.ListServiceEdgeRouterPolicyEdgeRoutersParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceEdgeRouterPolicyListServiceEdgeRouterPolicyServicesHandler == nil {
		api.ServiceEdgeRouterPolicyListServiceEdgeRouterPolicyServicesHandler = service_edge_router_policy.ListServiceEdgeRouterPolicyServicesHandlerFunc(func(params service_edge_router_policy.ListServiceEdgeRouterPolicyServicesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceListServiceEdgeRoutersHandler == nil {
		api.ServiceListServiceEdgeRoutersHandler = service.ListServiceEdgeRoutersHandlerFunc(func(params service.ListServiceEdgeRoutersParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceListServiceIdentitiesHandler == nil {
		api.ServiceListServiceIdentitiesHandler = service.ListServiceIdentitiesHandlerFunc(func(params service.ListServiceIdentitiesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServicePolicyListServicePoliciesHandler == nil {
		api.ServicePolicyListServicePoliciesHandler = service_policy.ListServicePoliciesHandlerFunc(func(params service_policy.ListServicePoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServicePolicyListServicePolicyIdentitiesHandler == nil {
		api.ServicePolicyListServicePolicyIdentitiesHandler = service_policy.ListServicePolicyIdentitiesHandlerFunc(func(params service_policy.ListServicePolicyIdentitiesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServicePolicyListServicePolicyPostureChecksHandler == nil {
		api.ServicePolicyListServicePolicyPostureChecksHandler = service_policy.ListServicePolicyPostureChecksHandlerFunc(func(params service_policy.ListServicePolicyPostureChecksParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServicePolicyListServicePolicyServicesHandler == nil {
		api.ServicePolicyListServicePolicyServicesHandler = service_policy.ListServicePolicyServicesHandlerFunc(func(params service_policy.ListServicePolicyServicesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.RoleAttributesListServiceRoleAttributesHandler == nil {
		api.RoleAttributesListServiceRoleAttributesHandler = role_attributes.ListServiceRoleAttributesHandlerFunc(func(params role_attributes.ListServiceRoleAttributesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceListServiceServiceEdgeRouterPoliciesHandler == nil {
		api.ServiceListServiceServiceEdgeRouterPoliciesHandler = service.ListServiceServiceEdgeRouterPoliciesHandlerFunc(func(params service.ListServiceServiceEdgeRouterPoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceListServiceServicePoliciesHandler == nil {
		api.ServiceListServiceServicePoliciesHandler = service.ListServiceServicePoliciesHandlerFunc(func(params service.ListServiceServicePoliciesParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SessionListSessionsHandler == nil {
		api.SessionListSessionsHandler = session.ListSessionsHandlerFunc(func(params session.ListSessionsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.InformationalListSummaryHandler == nil {
		api.InformationalListSummaryHandler = informational.ListSummaryHandlerFunc(func(params informational.ListSummaryParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.RouterListTransitRoutersHandler == nil {
		api.RouterListTransitRoutersHandler = router.ListTransitRoutersHandlerFunc(func(params router.ListTransitRoutersParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthPolicyPatchAuthPolicyHandler == nil {
		api.AuthPolicyPatchAuthPolicyHandler = auth_policy.PatchAuthPolicyHandlerFunc(func(params auth_policy.PatchAuthPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticatorPatchAuthenticatorHandler == nil {
		api.AuthenticatorPatchAuthenticatorHandler = authenticator.PatchAuthenticatorHandlerFunc(func(params authenticator.PatchAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CertificateAuthorityPatchCaHandler == nil {
		api.CertificateAuthorityPatchCaHandler = certificate_authority.PatchCaHandlerFunc(func(params certificate_authority.PatchCaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigPatchConfigHandler == nil {
		api.ConfigPatchConfigHandler = config.PatchConfigHandlerFunc(func(params config.PatchConfigParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigPatchConfigTypeHandler == nil {
		api.ConfigPatchConfigTypeHandler = config.PatchConfigTypeHandlerFunc(func(params config.PatchConfigTypeParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SettingsPatchControllerSettingHandler == nil {
		api.SettingsPatchControllerSettingHandler = settings.PatchControllerSettingHandlerFunc(func(params settings.PatchControllerSettingParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentAPISessionPatchCurrentIdentityAuthenticatorHandler == nil {
		api.CurrentAPISessionPatchCurrentIdentityAuthenticatorHandler = current_api_session.PatchCurrentIdentityAuthenticatorHandlerFunc(func(params current_api_session.PatchCurrentIdentityAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterPatchEdgeRouterHandler == nil {
		api.EdgeRouterPatchEdgeRouterHandler = edge_router.PatchEdgeRouterHandlerFunc(func(params edge_router.PatchEdgeRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterPolicyPatchEdgeRouterPolicyHandler == nil {
		api.EdgeRouterPolicyPatchEdgeRouterPolicyHandler = edge_router_policy.PatchEdgeRouterPolicyHandlerFunc(func(params edge_router_policy.PatchEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ExternalJWTSignerPatchExternalJWTSignerHandler == nil {
		api.ExternalJWTSignerPatchExternalJWTSignerHandler = external_jwt_signer.PatchExternalJWTSignerHandlerFunc(func(params external_jwt_signer.PatchExternalJWTSignerParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityPatchIdentityHandler == nil {
		api.IdentityPatchIdentityHandler = identity.PatchIdentityHandlerFunc(func(params identity.PatchIdentityParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.PostureChecksPatchPostureCheckHandler == nil {
		api.PostureChecksPatchPostureCheckHandler = posture_checks.PatchPostureCheckHandlerFunc(func(params posture_checks.PatchPostureCheckParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceEdgeRouterPolicyPatchServiceEdgeRouterPolicyHandler == nil {
		api.ServiceEdgeRouterPolicyPatchServiceEdgeRouterPolicyHandler = service_edge_router_policy.PatchServiceEdgeRouterPolicyHandlerFunc(func(params service_edge_router_policy.PatchServiceEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServicePolicyPatchServicePolicyHandler == nil {
		api.ServicePolicyPatchServicePolicyHandler = service_policy.PatchServicePolicyHandlerFunc(func(params service_policy.PatchServicePolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.RouterPatchTransitRouterHandler == nil {
		api.RouterPatchTransitRouterHandler = router.PatchTransitRouterHandlerFunc(func(params router.PatchTransitRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticatorReEnrollAuthenticatorHandler == nil {
		api.AuthenticatorReEnrollAuthenticatorHandler = authenticator.ReEnrollAuthenticatorHandlerFunc(func(params authenticator.ReEnrollAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterReEnrollEdgeRouterHandler == nil {
		api.EdgeRouterReEnrollEdgeRouterHandler = edge_router.ReEnrollEdgeRouterHandlerFunc(func(params edge_router.ReEnrollEdgeRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EnrollmentRefreshEnrollmentHandler == nil {
		api.EnrollmentRefreshEnrollmentHandler = enrollment.RefreshEnrollmentHandlerFunc(func(params enrollment.RefreshEnrollmentParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityRemoveIdentityMfaHandler == nil {
		api.IdentityRemoveIdentityMfaHandler = identity.RemoveIdentityMfaHandlerFunc(func(params identity.RemoveIdentityMfaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticatorRequestExtendAllCertAuthenticatorsHandler == nil {
		api.AuthenticatorRequestExtendAllCertAuthenticatorsHandler = authenticator.RequestExtendAllCertAuthenticatorsHandlerFunc(func(params authenticator.RequestExtendAllCertAuthenticatorsParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticatorRequestExtendAuthenticatorHandler == nil {
		api.AuthenticatorRequestExtendAuthenticatorHandler = authenticator.RequestExtendAuthenticatorHandlerFunc(func(params authenticator.RequestExtendAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthPolicyUpdateAuthPolicyHandler == nil {
		api.AuthPolicyUpdateAuthPolicyHandler = auth_policy.UpdateAuthPolicyHandlerFunc(func(params auth_policy.UpdateAuthPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.AuthenticatorUpdateAuthenticatorHandler == nil {
		api.AuthenticatorUpdateAuthenticatorHandler = authenticator.UpdateAuthenticatorHandlerFunc(func(params authenticator.UpdateAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CertificateAuthorityUpdateCaHandler == nil {
		api.CertificateAuthorityUpdateCaHandler = certificate_authority.UpdateCaHandlerFunc(func(params certificate_authority.UpdateCaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigUpdateConfigHandler == nil {
		api.ConfigUpdateConfigHandler = config.UpdateConfigHandlerFunc(func(params config.UpdateConfigParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ConfigUpdateConfigTypeHandler == nil {
		api.ConfigUpdateConfigTypeHandler = config.UpdateConfigTypeHandlerFunc(func(params config.UpdateConfigTypeParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.SettingsUpdateControllerSettingHandler == nil {
		api.SettingsUpdateControllerSettingHandler = settings.UpdateControllerSettingHandlerFunc(func(params settings.UpdateControllerSettingParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentAPISessionUpdateCurrentIdentityAuthenticatorHandler == nil {
		api.CurrentAPISessionUpdateCurrentIdentityAuthenticatorHandler = current_api_session.UpdateCurrentIdentityAuthenticatorHandlerFunc(func(params current_api_session.UpdateCurrentIdentityAuthenticatorParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterUpdateEdgeRouterHandler == nil {
		api.EdgeRouterUpdateEdgeRouterHandler = edge_router.UpdateEdgeRouterHandlerFunc(func(params edge_router.UpdateEdgeRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.EdgeRouterPolicyUpdateEdgeRouterPolicyHandler == nil {
		api.EdgeRouterPolicyUpdateEdgeRouterPolicyHandler = edge_router_policy.UpdateEdgeRouterPolicyHandlerFunc(func(params edge_router_policy.UpdateEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ExternalJWTSignerUpdateExternalJWTSignerHandler == nil {
		api.ExternalJWTSignerUpdateExternalJWTSignerHandler = external_jwt_signer.UpdateExternalJWTSignerHandlerFunc(func(params external_jwt_signer.UpdateExternalJWTSignerParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityUpdateIdentityHandler == nil {
		api.IdentityUpdateIdentityHandler = identity.UpdateIdentityHandlerFunc(func(params identity.UpdateIdentityParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.IdentityUpdateIdentityTracingHandler == nil {
		api.IdentityUpdateIdentityTracingHandler = identity.UpdateIdentityTracingHandlerFunc(func(params identity.UpdateIdentityTracingParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.PostureChecksUpdatePostureCheckHandler == nil {
		api.PostureChecksUpdatePostureCheckHandler = posture_checks.UpdatePostureCheckHandlerFunc(func(params posture_checks.UpdatePostureCheckParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServiceEdgeRouterPolicyUpdateServiceEdgeRouterPolicyHandler == nil {
		api.ServiceEdgeRouterPolicyUpdateServiceEdgeRouterPolicyHandler = service_edge_router_policy.UpdateServiceEdgeRouterPolicyHandlerFunc(func(params service_edge_router_policy.UpdateServiceEdgeRouterPolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.ServicePolicyUpdateServicePolicyHandler == nil {
		api.ServicePolicyUpdateServicePolicyHandler = service_policy.UpdateServicePolicyHandlerFunc(func(params service_policy.UpdateServicePolicyParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.RouterUpdateTransitRouterHandler == nil {
		api.RouterUpdateTransitRouterHandler = router.UpdateTransitRouterHandlerFunc(func(params router.UpdateTransitRouterParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CertificateAuthorityVerifyCaHandler == nil {
		api.CertificateAuthorityVerifyCaHandler = certificate_authority.VerifyCaHandlerFunc(func(params certificate_authority.VerifyCaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.CurrentIdentityVerifyMfaHandler == nil {
		api.CurrentIdentityVerifyMfaHandler = current_identity.VerifyMfaHandlerFunc(func(params current_identity.VerifyMfaParams, principal any) middleware.Responder {
			_ = params
			_ = principal
