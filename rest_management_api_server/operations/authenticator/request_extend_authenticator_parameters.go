...
// RequestExtendAuthenticatorParams contains all the bound params for the request extend authenticator operation
...
func (o *RequestExtendAuthenticatorParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
