...
// RequestExtendAllCertAuthenticatorsParams contains all the bound params for the request extend all cert authenticators operation
...
func (o *RequestExtendAllCertAuthenticatorsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body rest_model.RequestExtendAuthenticator
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("requestExtendAuthenticator", "body", ""))
			} else {
				res = append(res, errors.NewParseError("requestExtendAuthenticator", "body", "", err))
			}
		} else {
			...
			if len(res) == 0 {
				o.RequestExtendAuthenticator = &body
			}
		}
	} else {
		res = append(res, errors.Required("requestExtendAuthenticator", "body", ""))
...
func (o *RequestExtendAllCertAuthenticatorsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
