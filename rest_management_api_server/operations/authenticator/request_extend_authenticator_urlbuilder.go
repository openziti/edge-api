...
type RequestExtendAuthenticatorURL struct {
	ID string
...
func (o *RequestExtendAuthenticatorURL) Build() (*url.URL, error) {
	...
	var _path = "/authenticators/{id}/request-extend"

	id := o.ID
	if id != "" {
		_path = strings.ReplaceAll(_path, "{id}", id)
	} else {
		return nil, errors.New("id is required on RequestExtendAuthenticatorURL")
	}
...
func (o *RequestExtendAuthenticatorURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RequestExtendAuthenticatorURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RequestExtendAuthenticatorURL")
	}
