...
type RequestExtendAllCertAuthenticatorsURL struct {
	ID string
...
func (o *RequestExtendAllCertAuthenticatorsURL) Build() (*url.URL, error) {
	...
	var _path = "/identities/{id}/request-extend"

	id := o.ID
	if id != "" {
		_path = strings.ReplaceAll(_path, "{id}", id)
	} else {
		return nil, errors.New("id is required on RequestExtendAllCertAuthenticatorsURL")
	}
...
func (o *RequestExtendAllCertAuthenticatorsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on RequestExtendAllCertAuthenticatorsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on RequestExtendAllCertAuthenticatorsURL")
	}
