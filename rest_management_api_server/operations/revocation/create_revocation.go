...
func (fn CreateRevocationHandlerFunc) Handle(params CreateRevocationParams, principal any) middleware.Responder {
...
func NewCreateRevocation(ctx *middleware.Context, handler CreateRevocationHandler) *CreateRevocation {
	return &CreateRevocation{Context: ctx, Handler: handler}
}
...
func (o *CreateRevocation) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewCreateRevocationParams()
