...
func (fn DetailRevocationHandlerFunc) Handle(params DetailRevocationParams, principal any) middleware.Responder {
...
func NewDetailRevocation(ctx *middleware.Context, handler DetailRevocationHandler) *DetailRevocation {
	return &DetailRevocation{Context: ctx, Handler: handler}
}
...
func (o *DetailRevocation) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewDetailRevocationParams()
