...
// CreateRevocationParams contains all the bound params for the create revocation operation
...
func (o *CreateRevocationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		...
		var body rest_model.RevocationCreate
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if stderrors.Is(err, io.EOF) {
				res = append(res, errors.Required("revocation", "body", ""))
			} else {
				res = append(res, errors.NewParseError("revocation", "body", "", err))
			}
		} else {
