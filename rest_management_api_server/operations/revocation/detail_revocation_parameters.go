...
// DetailRevocationParams contains all the bound params for the detail revocation operation
...
func (o *DetailRevocationParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
