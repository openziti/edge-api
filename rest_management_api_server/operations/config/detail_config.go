...
type DetailConfigHandlerFunc func(DetailConfigParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn DetailConfigHandlerFunc) Handle(params DetailConfigParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// DetailConfigHandler interface for that can handle valid detail config params
type DetailConfigHandler interface {
	Handle(DetailConfigParams, any) middleware.Responder
}
