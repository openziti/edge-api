...
type AuthenticateMfaHandlerFunc func(AuthenticateMfaParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn AuthenticateMfaHandlerFunc) Handle(params AuthenticateMfaParams, principal any) middleware.Responder {
...
type AuthenticateMfaHandler interface {
	Handle(AuthenticateMfaParams, any) middleware.Responder
}
