...
type CreateCaHandlerFunc func(CreateCaParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateCaHandlerFunc) Handle(params CreateCaParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// CreateCaHandler interface for that can handle valid create ca params
type CreateCaHandler interface {
	Handle(CreateCaParams, any) middleware.Responder
}
