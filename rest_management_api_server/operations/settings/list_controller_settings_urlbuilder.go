...
func (o *ListControllerSettingsURL) WithBasePath(bp string) *ListControllerSettingsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ListControllerSettingsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListControllerSettingsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListControllerSettingsURL")
	}
