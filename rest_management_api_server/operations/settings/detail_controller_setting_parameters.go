...
// DetailControllerSettingParams contains all the bound params for the detail controller setting operation
...
func (o *DetailControllerSettingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DetailControllerSettingParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
