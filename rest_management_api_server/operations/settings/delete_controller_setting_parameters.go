...
// DeleteControllerSettingParams contains all the bound params for the delete controller setting operation
...
func (o *DeleteControllerSettingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteControllerSettingParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
