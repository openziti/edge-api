...
func (o *UpdateControllerSettingURL) WithBasePath(bp string) *UpdateControllerSettingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateControllerSettingURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on UpdateControllerSettingURL")
	}
...
func (o *UpdateControllerSettingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateControllerSettingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateControllerSettingURL")
	}
