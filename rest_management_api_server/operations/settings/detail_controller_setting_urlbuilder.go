...
func (o *DetailControllerSettingURL) WithBasePath(bp string) *DetailControllerSettingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DetailControllerSettingURL) Build() (*url.URL, error) {
	...
	var _path = "/controller-settings/{id}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on DetailControllerSettingURL")
	}
...
func (o *DetailControllerSettingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DetailControllerSettingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DetailControllerSettingURL")
	}
