...
// DetailControllerSettingEffectiveParams contains all the bound params for the detail controller setting effective operation
...
func (o *DetailControllerSettingEffectiveParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DetailControllerSettingEffectiveParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
