...
func (o *PatchControllerSettingURL) WithBasePath(bp string) *PatchControllerSettingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PatchControllerSettingURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on PatchControllerSettingURL")
	}
...
func (o *PatchControllerSettingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PatchControllerSettingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PatchControllerSettingURL")
	}
