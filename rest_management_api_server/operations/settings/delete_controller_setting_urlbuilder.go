...
func (o *DeleteControllerSettingURL) WithBasePath(bp string) *DeleteControllerSettingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteControllerSettingURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on DeleteControllerSettingURL")
	}
...
func (o *DeleteControllerSettingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteControllerSettingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteControllerSettingURL")
	}
