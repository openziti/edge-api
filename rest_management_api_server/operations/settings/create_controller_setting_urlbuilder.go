...
func (o *CreateControllerSettingURL) WithBasePath(bp string) *CreateControllerSettingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateControllerSettingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateControllerSettingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateControllerSettingURL")
	}
