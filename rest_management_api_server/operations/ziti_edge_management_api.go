...
func (o *ZitiEdgeManagementAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/authenticators/{id}/request-extend"] = authenticator.NewRequestExtendAuthenticator(o.context, o.AuthenticatorRequestExtendAuthenticatorHandler)
