...
type EnableIdentityHandlerFunc func(EnableIdentityParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn EnableIdentityHandlerFunc) Handle(params EnableIdentityParams, principal any) middleware.Responder {
...
type EnableIdentityHandler interface {
	Handle(EnableIdentityParams, any) middleware.Responder
}
