...
type DeleteIdentityHandlerFunc func(DeleteIdentityParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteIdentityHandlerFunc) Handle(params DeleteIdentityParams, principal any) middleware.Responder {
...
type DeleteIdentityHandler interface {
	Handle(DeleteIdentityParams, any) middleware.Responder
}
