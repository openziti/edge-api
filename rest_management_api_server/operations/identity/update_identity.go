...
type UpdateIdentityHandlerFunc func(UpdateIdentityParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateIdentityHandlerFunc) Handle(params UpdateIdentityParams, principal any) middleware.Responder {
...
type UpdateIdentityHandler interface {
	Handle(UpdateIdentityParams, any) middleware.Responder
}
