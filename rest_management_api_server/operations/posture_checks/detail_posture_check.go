...
type DetailPostureCheckHandlerFunc func(DetailPostureCheckParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn DetailPostureCheckHandlerFunc) Handle(params DetailPostureCheckParams, principal any) middleware.Responder {
...
type DetailPostureCheckHandler interface {
	Handle(DetailPostureCheckParams, any) middleware.Responder
}
