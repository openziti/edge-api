...
type ListServiceEdgeRouterPoliciesHandlerFunc func(ListServiceEdgeRouterPoliciesParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn ListServiceEdgeRouterPoliciesHandlerFunc) Handle(params ListServiceEdgeRouterPoliciesParams, principal any) middleware.Responder {
...
type ListServiceEdgeRouterPoliciesHandler interface {
	Handle(ListServiceEdgeRouterPoliciesParams, any) middleware.Responder
}
