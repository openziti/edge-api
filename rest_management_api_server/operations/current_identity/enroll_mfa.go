...
type EnrollMfaHandlerFunc func(EnrollMfaParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn EnrollMfaHandlerFunc) Handle(params EnrollMfaParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// EnrollMfaHandler interface for that can handle valid enroll mfa params
type EnrollMfaHandler interface {
	Handle(EnrollMfaParams, any) middleware.Responder
}
