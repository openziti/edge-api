...
import (
	...
	"github.com/openziti/edge-api/go/rest_client_api_server/operations"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/authentication"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/current_api_session"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/current_identity"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/enroll"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/external_jwt_signer"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/informational"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/posture_checks"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/service"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/session"
	"github.com/openziti/edge-api/go/rest_client_api_server/operations/well_known"
)

//go:generate swagger generate server --target ../../go --name ZitiEdgeClient --spec ../../client.yml --model-package rest_model --server-package rest_client_api_server --principal interface{} --exclude-main
