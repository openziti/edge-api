...
import (
	...
	"github.com/openziti/edge-api/go/rest_management_api_server/operations"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/api_session"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/auth_policy"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/authentication"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/authenticator"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/certificate_authority"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/config"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/current_api_session"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/current_identity"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/database"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/edge_router"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/edge_router_policy"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/enrollment"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/external_jwt_signer"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/identity"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/informational"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/posture_checks"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/role_attributes"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/router"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/service"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/service_edge_router_policy"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/service_policy"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/session"
	"github.com/openziti/edge-api/go/rest_management_api_server/operations/terminator"
)

//go:generate swagger generate server --target ../../go --name ZitiEdgeManagement --spec ../../management.yml --model-package rest_model --server-package rest_management_api_server --principal interface{} --exclude-main
